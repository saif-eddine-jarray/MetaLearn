...
export function Step2 (props) {
    ...
    const formik = useFormik({
        ...
        onSubmit: (data) => {
            ...
            const student={firstName,lastName,parentName,age}
            const user={username,email,password,student};
            console.log(user);
                ...
                <div className="flex justify-content-center">
                    <div className="card">
                        <form onSubmit={formik.handleSubmit} className="p-fluid">
                            ...
                            <div className="field">
                                <span className="p-float-label">
                                    <InputText id="parentname" name="parentname" value={formik.values.parentname} onChange={formik.handleChange} />
